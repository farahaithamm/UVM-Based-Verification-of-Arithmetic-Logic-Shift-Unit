  ...
  if(rst) begin
    ...
    if (bypass_A_reg && bypass_B_reg)
      ...
      out <= 0;
        ...
        case (opcode_reg) // should be opcode_reg not opcode
          3'h0: begin 
          ...
          3'h2: out <= (FULL_ADDER == "ON") ? A_reg + B_reg + cin_reg : A_reg + B_reg; // considered full adder mode on
